    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-3 w-full">
            <div>
                ...
                <h2 class="text-2xl font-semibold text-gray-900">{{ __('Ubah Dokumentasi') }}</h2>
                <p class="text-sm text-gray-500">Perbarui informasi kegiatan yang sudah diterbitkan.</p>
            </div>
