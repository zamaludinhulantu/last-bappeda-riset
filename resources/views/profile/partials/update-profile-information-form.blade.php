<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="surel" name="surel" type="email" class="mt-1 block w-full" :value="old('surel', $user->surel)" required autocomplete="username" />
            <x-input-error class="mt-2" :messages="$errors->get('surel')" />
