            ...
            <form action="{{ route('researches.update', $research->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="judul" value="{{ old('judul', $research->judul) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="hidden" name="penulis" value="{{ old('penulis', $research->penulis) }}" data-authors-hidden>
                        <div class="space-y-2" data-authors-wrapper>
                            @php
                                $authorSeed = old('penulis', $research->penulis);
                                $authorsOld = collect(preg_split('/[;,]+/', (string)$authorSeed))->map(fn($v) => trim($v))->filter()->values();
                    ...
                    <div>
                        ...
                        <input type="text" name="nik_peneliti" value="{{ old('nik_peneliti', $research->nik_peneliti) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="telepon_peneliti" value="{{ old('telepon_peneliti', $research->telepon_peneliti) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div>
                        ...
                        <select name="bidang_id" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" data-field-select>
                            ...
                            @foreach ($fields as $field)
                                <option value="{{ $field->id }}" @selected(old('bidang_id', $research->bidang_id) == $field->id)>{{ $field->nama }}</option>
                            @endforeach
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_institusi" value="{{ old('nama_institusi', optional($research->institution)->nama) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" value="{{ old('lokasi', $research->lokasi) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun" value="{{ old('tahun', $research->tahun) }}" min="2000" max="{{ date('Y') }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="abstrak" rows="4" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" placeholder="Ringkasan singkat sebelum mengunggah file lengkap">{{ old('abstrak', $research->abstrak) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:col-span-2">
                        <div>
                            ...
                            <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai', optional($research->tanggal_mulai)->format('Y-m-d')) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai', optional($research->tanggal_selesai)->format('Y-m-d')) }}" class="mt-1 w-full rounded-lg border-gray-200 focus:border-orange-500 focus:ring-orange-500" required>
                    ...
                    <div class="grid gap-3 rounded-xl border border-[#dfeafe] bg-white/90 p-4 shadow-sm">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            @if($research->berkas_surat_kampus)
                                <p class="text-xs text-gray-500">Berkas saat ini:
                                    <a href="{{ route('researches.download', [$research, 'berkas_surat_kampus']) }}" class="text-orange-600 hover:underline">lihat surat universitas/instansi/lembaga</a>
                                </p>
                            @endif
                    ...
                    <div>
                        ...
                        @if($research->berkas_pdf)
                            <p class="text-xs text-gray-500 mt-1">Berkas saat ini:
                                <a href="{{ route('researches.download', [$research, 'berkas_pdf']) }}" class="text-orange-600 hover:underline">unduh proposal</a>
                            </p>
                        @endif
                    ...
                    @if(auth()->user()?->hasAdminAccess())
                        <div>
                            ...
                            @if($research->berkas_hasil)
                                <p class="text-xs text-gray-500 mt-1">Berkas hasil saat ini:
                                    <a href="{{ route('researches.download', [$research, 'berkas_hasil']) }}" class="text-orange-600 hover:underline">unduh hasil</a>
                                </p>
                            @endif
                        ...
                        <div class="grid gap-3 rounded-xl border border-cyan-100 bg-white/70 p-4">
                            ...
                            @if($research->berkas_surat_kesbang)
                                <p class="text-xs text-gray-500 mt-1">Berkas saat ini:
                                    <a href="{{ route('researches.download', [$research, 'berkas_surat_kesbang']) }}" class="text-orange-600 hover:underline">lihat</a>
                                </p>
                            @endif
                            <div class="grid gap-3 sm:grid-cols-2">
                                <div class="space-y-1">
                                    <label class="text-xs font-semibold text-gray-700">Nomor Surat</label>
                                    <input type="text" name="nomor_surat_kesbang" value="{{ old('nomor_surat_kesbang', $research->nomor_surat_kesbang) }}" class="w-full rounded-lg border-gray-200 text-sm focus:border-cyan-500 focus:ring-cyan-500" placeholder="Contoh: 070/Kesbangpol/IX/2025">
                                </div>
                                <div class="space-y-1">
                                    <label class="text-xs font-semibold text-gray-700">Tanggal Surat</label>
                                    <input type="date" name="tanggal_surat_kesbang" value="{{ old('tanggal_surat_kesbang', optional($research->tanggal_surat_kesbang)->format('Y-m-d')) }}" class="w-full rounded-lg border-gray-200 text-sm focus:border-cyan-500 focus:ring-cyan-500">
                                </div>
                            </div>
